...
const url = process.env.API_URL_PPENNONT2024; // Use environment variable for URL

// Define the spreadsheet ID and range
const spreadsheetId = process.env.SPREADSHEET_ID; // Use environment variable for Spreadsheet ID
const clearRange = 'P-PenNonTender2024!A:ZZ'; // Range to clear
const updateRange = 'P-PenNonTender2024!A1'; // Range to update
